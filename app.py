  ...
  <div style="display:grid;grid-template-columns:1fr 1fr;gap:2rem">
    ...
    <div>
      ...
      <table style="width:100%;font-size:14px;border-collapse:collapse">
        ...
        <tr><td style="color:#64748B;padding:5px 0;border-bottom:1px solid #F1F5F9">Approval threshold</td><td style="font-weight:600;text-align:right;padding:5px 0;border-bottom:1px solid #F1F5F9">{thr*100:.1f}%</td></tr>
